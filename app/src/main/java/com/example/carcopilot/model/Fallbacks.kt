...
private val FALLBACK_SYNTHESIS: Map<String, String> = mapOf(
    ...
    "P0670" to "The glow plug control module has a fault. Without pre-heating, the cylinders won't ignite fuel properly in cold weather.",
    "P0671" to "Cylinder 1's glow plug isn't working. Diesel engines rely on glow plugs to heat the cylinder before starting — without it, cold starts become difficult.",
    "P0672" to "Cylinder 2's glow plug isn't working. Cold starting will be harder, especially when the engine is at ambient temperature.",
    "P0673" to "Cylinder 3's glow plug isn't working. Cold starting will be harder.",
    "P0674" to "Cylinder 4's glow plug isn't working. Cold starting will be harder.",
)
...
private val FALLBACK_GOOD_NEWS: Map<String, String> = mapOf(
    ...
    "P0671" to "Glow plugs are cheap and straightforward to swap. I can walk you through it.",
    "P0672" to "Glow plugs are cheap and straightforward to swap. I can walk you through it.",
    "P0673" to "Glow plugs are cheap and straightforward to swap. I can walk you through it.",
    "P0674" to "Glow plugs are cheap and straightforward to swap. I can walk you through it.",
)
